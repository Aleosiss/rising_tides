...
static function X2AbilityTemplate RTProgramEvacuationPartTwo()
{
	...
	Template.BuildVisualizationFn = ProgramOperativecDefeatedEscape_BuildVisualization;
...
simulated function ProgramOperativecDefeatedEscape_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory History;
