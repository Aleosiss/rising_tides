...
static function X2CharacterTemplate CreateWhisperTemplate()
{
	...
	CharTemplate.ForceAppearance.nmTorso = 'RT_MamaMEA_Pathfinder_Und_Secondary_Torso_M';
	//CharTemplate.ForceAppearance.nmArms = None;
	CharTemplate.ForceAppearance.nmLegs = 'RT_MamaMEA_Pathfinder_Und_Legs_M';
	CharTemplate.ForceAppearance.nmHelmet = 'RT_MamaMEA_Remnant_Heavy_Helmet_M';
	...
	CharTemplate.ForceAppearance.nmLeftArm = 'RT_MamaMEA_Pathfinder_Und_Secondary_Arm_Left_M';
	CharTemplate.ForceAppearance.nmRightArm = 'RT_MamaMEA_Pathfinder_Und_Secondary_Arm_Right_M';
	CharTemplate.ForceAppearance.nmLeftArmDeco = 'RT_MamaMEA_Remnant_Hvy_Arm_Left_M';
	CharTemplate.ForceAppearance.nmRightArmDeco = 'RT_MamaMEA_Remnant_Hvy_Arm_Right_M';
	...
	CharTemplate.ForceAppearance.nmShins = 'RT_MamaMEA_Remnant_Hvy_Legs_M';
	CharTemplate.ForceAppearance.nmTorsoDeco = 'RT_MamaMEA_Remnant_Hvy_Torso_M';
...
static function X2CharacterTemplate CreateQueenTemplate()
{
	...
	CharTemplate.ForceAppearance.nmTorso = 'RT_MamaMEA_Pathfinder_Und_Secondary_Torso_F';
	CharTemplate.ForceAppearance.nmArms = 'PwrLgt_Std_A_F';
	CharTemplate.ForceAppearance.nmLegs = 'RT_MamaMEA_Pathfinder_Und_Legs_F';
	CharTemplate.ForceAppearance.nmHelmet = 'RT_MamaMEA_Remnant_Heavy_Helmet_F';
	CharTemplate.ForceAppearance.nmEye = 'DefaultEyes_3';
	CharTemplate.ForceAppearance.nmTeeth = 'DefaultTeeth';
	CharTemplate.ForceAppearance.nmFacePropLower = 'Prop_FaceLower_Blank';
	CharTemplate.ForceAppearance.nmFacePropUpper = 'Prop_FaceUpper_Blank';
	...
	//CharTemplate.ForceAppearance.nmFacePaint = None;
	CharTemplate.ForceAppearance.nmLeftArm = 'RT_MamaMEA_Pathfinder_Und_Secondary_Arm_Left_F';
	CharTemplate.ForceAppearance.nmRightArm = 'RT_MamaMEA_Pathfinder_Und_Secondary_Arm_Right_F';
	CharTemplate.ForceAppearance.nmLeftArmDeco = 'RT_MamaMEA_Remnant_Hvy_Arm_Left_F';
	CharTemplate.ForceAppearance.nmRightArmDeco = 'RT_MamaMEA_Remnant_Hvy_Arm_Right_F';
	//CharTemplate.ForceAppearance.nmLeftForearm = None;
	//CharTemplate.ForceAppearance.nmRightForearm = None;
	//CharTemplate.ForceAppearance.nmThighs = None;
	CharTemplate.ForceAppearance.nmShins = 'RT_MamaMEA_Remnant_Hvy_Legs_F';
	CharTemplate.ForceAppearance.nmTorsoDeco = 'RT_MamaMEA_Remnant_Hvy_Torso_F';
	CharTemplate.ForceAppearance.bGhostPawn = False;
...
static function X2CharacterTemplate CreateNovaTemplate()
{
	...
	CharTemplate.ForceAppearance.nmWeaponPattern = 'Hex';
	CharTemplate.ForceAppearance.nmPawn = 'XCom_Soldier_F';
	CharTemplate.ForceAppearance.nmTorso = 'RT_MamaMEA_Pathfinder_Und_Torso_F';
	CharTemplate.ForceAppearance.nmArms = 'PwrLgt_Std_A_F';
	CharTemplate.ForceAppearance.nmLegs = 'RT_MamaMEA_Pathfinder_Und_Legs_F';
	CharTemplate.ForceAppearance.nmHelmet = 'RT_MamaMEA_Remnant_Heavy_Helmet_F';
	CharTemplate.ForceAppearance.nmEye = 'DefaultEyes_3';
