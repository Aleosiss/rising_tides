...
## Current Table
	...
	- Gatherer:
		...
		- New Perk Idea:
			- The Veil: If all active enemies are affected by Over The Shoulder, this ability can be activated to gain concealement. 6-turn cooldown. Cannot be used when flanked (same as Conceal ability).
	- General:
		- none
